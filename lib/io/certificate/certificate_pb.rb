...
module Io
  ...
  AppleCertificateRenewalAuthority = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("io.AppleCertificateRenewalAuthority").msgclass
  CreateAppleCertificateRenewalAuthorityRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("io.CreateAppleCertificateRenewalAuthorityRequest").msgclass
  GetAppleCertificateRenewalAuthorityRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("io.GetAppleCertificateRenewalAuthorityRequest").msgclass
  UpdateAppleCertificateRenewalAuthorityRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("io.UpdateAppleCertificateRenewalAuthorityRequest").msgclass
  ListAppleCertificateRenewalAuthoritiesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("io.ListAppleCertificateRenewalAuthoritiesRequest").msgclass
  DeleteAppleCertificateRenewalAuthorityResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("io.DeleteAppleCertificateRenewalAuthorityResponse").msgclass
end
